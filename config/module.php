...
return [
    ...
    'pluginManager' => [
        'pluginMap' => [
            'Settings' => [
                'title' => 'Display module settings',
                'class' => 'Gm\Backend\Menu\Plugin\MenuItemSettings'
            ],
            'Append' => [
                'title' => 'Display module append',
                'class' => 'Gm\Backend\Menu\Plugin\MenuItemAppend'
            ]
        ]
    ],
